...
import {
  daysOfWeekIntl,
  DayPickerHeader,
} from 'library/range-picker-timepicker/day-picker-header';
import { DayPickerRow } from 'library/range-picker-timepicker/day-picker-row';
...
function F_DayPicker({
  ...
  return (
    ...
    <div role='radiogroup' tabIndex={0} className={daysClassName}>
      <DayPickerHeader
        locale={locale}
        weekDays={weekDays}
