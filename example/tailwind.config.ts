  ...
  theme: {
    extend: {
      colors: {
        dark: {
          main_logo: '#16B862',
          main_background: '#0d0f22',
          main_widget_surface: '#0D0F22',
          main_widget_border: '#2D2F43',
          main_alternative_colors: '#0D74E7',
          main_icons: '#BBBCD5',

          breadcrumbs_text: '#51E085',
          breadcrumbs_icon: '#51E085',
          breadcrumbs_divider: '#BBBCD5',

          button_primary_background_default: '#00a656',
          button_primary_border_default: '#05924f',
          button_primary_text_default: '#FFFFFF',
          button_primary_icon_default: '#FFFFFF',

          button_primary_background_focus: '#51E085',
          button_primary_border_focus: '#413E53',
          button_primary_text_focus: '#FFFFFF',
          button_primary_icon_focus: '#FFFFFF',

          button_primary_background_hover: '#008946',
          button_primary_border_hover: '#057a42',
          button_primary_text_hover: '#FFFFFF',
          button_primary_icon_hover: '#FFFFFF',

          button_primary_background_disabled: '#00602F',
          button_primary_border_disabled: '#00602F',
          button_primary_text_disabled: '#9495A9',
          button_primary_icon_disabled: '#9495A9',

          button_primary_background_inactive: '#413E53',
          button_primary_text_inactive: '#BBBCD5',
          button_primary_icon_inactive: '#BBBCD5',

          button_primary_background_pressed: '#006D36',
          button_primary_border_pressed: '#056234',
          button_primary_text_pressed: '#FFFFFF',
          button_primary_icon_pressed: '#FFFFFF',

          button_secondary_background_default: '#0D0F22',
          button_secondary_border_default: '#BBBCD5',
          button_secondary_text_default: '#BBBCD5',
          button_secondary_icon_default: '#BBBCD5',

          button_secondary_background_focus: '#0d0f22',
          button_secondary_border_focus: '#00a656',
          button_secondary_text_focus: '#FFFFFF',
          button_secondary_icon_focus: '#FFFFFF',

          button_secondary_background_hover: '#0D0F22',
          button_secondary_border_hover: '#FFFFFF',
          button_secondary_text_hover: '#FFFFFF',
          button_secondary_icon_hover: '#FFFFFF',

          button_secondary_background_pressed: '#27273B',
          button_secondary_border_pressed: '#FFFFFF',
          button_secondary_text_pressed: '#FFFFFF',
          button_secondary_icon_pressed: '#FFFFFF',

          button_secondary_background_disabled: '#27273B',
          button_secondary_border_disabled: '#343347',
          button_secondary_text_disabled: '#9495A9',
          button_secondary_icon_disabled: '#9495A9',

          button_secondary_background_inactive: '#27273B',
          button_secondary_border_inactive: 'transparent',
          button_secondary_text_inactive: '#BBBCD5',
          button_secondary_icon_inactive: '#BBBCD5',

          button_danger_background_default: '#FF5449',
          button_danger_border_default: 'transparent',
          button_danger_text_default: '#FFFFFF',
          button_danger_icon_default: '#FFFFFF',

          button_danger_background_focus: '#FF5449',
          button_danger_border_focus: '#F5F7FA',
          button_danger_text_focus: '#FFFFFF',
          button_danger_icon_focus: '#FFFFFF',

          button_danger_background_hover: '#BA1A1A',
          button_danger_border_hover: '#DE3730',
          button_danger_text_hover: '#FFFFFF',
          button_danger_icon_hover: '#FFFFFF',

          button_danger_background_pressed: '#A80710',
          button_danger_border_pressed: '#BA1A1A',
          button_danger_text_pressed: '#FFFFFF',
          button_danger_icon_pressed: '#FFFFFF',

          button_danger_background_disabled: '#410002',
          button_danger_border_disabled: 'transparent',
          button_danger_text_disabled: '#BBBCD5',
          button_danger_icon_disabled: '#BBBCD5',

          button_danger_background_inactive: '#2D0001',
          button_danger_border_inactive: 'transparent',
          button_danger_text_inactive: '#EAEEF2',
          button_danger_icon_inactive: '#EAEEF2',

          button_invisible_background_default: 'transparent',
          button_invisible_border_default: '#16B862',
          button_invisible_text_default: '#16B862',
          button_invisible_icon_default: '#16B862',

          button_invisible_background_focus: 'transparent',
          button_invisible_border_focus: '#16B862',
          button_invisible_text_focus: '#16B862',
          button_invisible_icon_focus: '#16B862',

          button_invisible_background_hover: '#27273B',
          button_invisible_border_hover: '#16B862',
          button_invisible_text_hover: '#16B862',
          button_invisible_icon_hover: '#16B862',

          button_invisible_background_pressed: 'transparent',
          button_invisible_border_pressed: '#51E085',
          button_invisible_text_pressed: '#51E085',
          button_invisible_icon_pressed: '#51E085',

          button_invisible_background_disabled: 'transparent',
          button_invisible_border_disabled: '#2D2F43',
          button_invisible_text_disabled: '#2D2F43',
          button_invisible_icon_disabled: '#2D2F43',

          button_invisible_background_inactive: 'transparent',
          button_invisible_border_inactive: '#413E53',
          button_invisible_text_inactive: '#9495A9',
          button_invisible_icon_inactive: '#9495A9',

          button_alternative_background_default: '#0D74E7',
          button_alternative_border_default: '#0D74E7',
          button_alternative_text_default: '#FFFFFF',
          button_alternative_icon_default: '#FFFFFF',

          button_alternative_background_focus: '#0969DA',
          button_alternative_border_focus: '#413E53',
          button_alternative_text_focus: '#FFFFFF',
          button_alternative_icon_focus: '#FFFFFF',

          button_alternative_background_hover: '#0D74E7',
          button_alternative_border_hover: '#0969DA',
          button_alternative_text_hover: '#FFFFFF',
          button_alternative_icon_hover: '#FFFFFF',

          button_alternative_background_pressed: '#0D74E7',
          button_alternative_border_pressed: '#0D74E7',
          button_alternative_text_pressed: '#FFFFFF',
          button_alternative_icon_pressed: '#FFFFFF',

          button_alternative_background_disabled: '#0969DA',
          button_alternative_border_disabled: '#0969DA',
          button_alternative_text_disabled: '#9495A9',
          button_alternative_icon_disabled: '#9495A9',

          button_alternative_background_inactive: '#413E53',
          button_alternative_border_inactive: 'transparent',
          button_alternative_text_inactive: '#BBBCD5',
          button_alternative_icon_inactive: '#BBBCD5',

          checkbox_background_default: '#1F2328',
          checkbox_background_checked: '#16B862',
          checkbox_background_indeterminate: '#545357',

          checkbox_border_default: '#BBBCD5',
          checkbox_border_focus: '#F5F7FA',

          checkbox_icon_checked: '#F5F7FA',
          checkbox_icon_indeterminate: '#BBBCD5',

          checkbox_text_indeterminate: '#BBBCD5',

          datepicker_background: '#374151',
          datepicker_border: '#9CA3AF',
          datepicker_days: '#FFFFFF',
          datepicker_weeks_months: '#9CA3AF',
          datepicker_day_inversion: '#D9D9D9',

          footer_copyright: '#7D7B8C',
          footer_link: '#BBBCD5',

          footer_nav_default: '#BBBCD5',
          footer_nav_active: '#CFCFE0',
          footer_nav_visited: '#BBBCD5',
          footer_nav_hover: '#DDDDEA',

          input_caption_text: '#BBBCD5',

          input_background_default: '#27273B',
          input_background_inset: '#27273B',
          input_background_disabled: '#27273B',
          input_background_readonly: '#27273B',

          input_placeholder_default: '#BBBCD5',
          input_placeholder_inset: '#D9D9D9',
          input_placeholder_hover: '#F6F6FC',
          input_placeholder_disabled: '#726F94',
          input_placeholder_readonly: '#BBBCD5',

          input_border_default: '#BBBCD5',
          input_border_hover: '#BBBCD5',
          input_border_invalid: '#DE3730',
          input_border_valid: '#51E085',
          input_border_focus: '#E0E1F3',
          input_border_pressed: '#BBBCD5',
          input_border_disabled: '#49494D',

          input_icon_default: '#BBBCD5',
          input_icon_hover: '#BBBCD5',
          input_icon_invalid: '#DE3730',
          input_icon_valid: '#51E085',
          input_icon_focus: '#E0E1F3',
          input_icon_pressed: '#BBBCD5',
          input_icon_disabled: '#49494D',

          input_message_invalid: '#FF5449',
          input_message_valid: '#51E085',

          link_background_surface_anchor: '#0D0F22',
          link_background_anchor: '#27273B',

          link_border_anchor_active: '#BBBCD5',
          link_border_anchor_surface: '#D9D9D9',
          link_border_anchor_muted: '#27273B',

          link_text_default: '#BBBCD5',
          link_text_accent_green: '#51E085',
          link_text_accent_light: '#F5F7FA',

          link_icon_leading_default: '#BBBCD5',
          link_icon_leading_accent_green: '#51E085',
          link_icon_leading_accent_light: '#F5F7FA',
          link_icon_trailing: '#F5F7FA',

          menu_nav_default: '#E0E1F3',
          menu_nav_active: '#E0E1F3',
          menu_nav_visited: '#E0E1F3',
          menu_nav_hover: '#DDDDEA',

          menu_ham_menu_open: '#BBBCD5',
          menu_ham_menu_closed: '#BBBCD5',

          pagination_page_direction_default: '#2CC36C',
          pagination_page_direction_hover: '#2CC36C',
          pagination_page_direction_disabled: '#BBBCD5',

          pagination_background_current: '#16B862',

          pagination_border_hover: '#BBBCD5',

          pagination_text_default: '#BBBCD5',
          pagination_text_hover: '#F5F7FA',
          pagination_text_current: '#F5F7FA',

          radio_background_unchecked: '#0D0F22',
          radio_background_disabled: '#ffffff',

          radio_dot_default: '#51E085',
          radio_dot_disabled: '#7D7B8C',

          radio_border_default: '#BBBCD5',
          radio_border_focus: '#51E085',
          radio_border_disabled: '#49494D',

          select_background_default: '#413E53',
          select_text_default: '#BBBCD5',
          select_icon_default: '#BBBCD5',

          select_background_hover: '#2D2F43',
          select_text_hover: '#BBBCD5',
          select_icon_hover: '#BBBCD5',

          select_background_selected: '#413E53',
          select_text_selected: '#D9D9D9',
          select_icon_selected: '#D9D9D9',

          code_navigator_background: '#0D0F22',
          code_navigator_chevron: '#BBBCD5',
          code_navigator_folder: '#51E085',
          code_navigator_text: '#BBBCD5',
          code_navigator_icon: '#BBBCD5',
          code_navigator_focus: '#E0E1F3',
          code_navigator_tag: '#C78603',

          tag_label_violet: '#BF3989',
          tag_label_purple: '#8250DF',
          tag_label_red: '#DF0404',
          tag_label_orange: '#BF8700',
          tag_label_green: '#0FC966',
          tag_label_blue: '#75D0DC',
          tag_label_grey: '#9495A9',
          tag_label_light: '#F3F4FF',

          text_default: '#BBBCD5',
          text_title: '#F5F7FA',
          text_subtitle: '#BBBCD5',
          text_lines_of_subtitle: '#BBBCD5',
          text_label: '#BBBCD5',

          toggle_switch_text_default: '#BBBCD5',

          toggle_switch_border_default: '#5B5D73',

          toggle_switch_toggle_on: '#FFFFFF',
          toggle_switch_toggle_off: '#A8A9C2',

          toggle_switch_background_on: '#16B862',
          toggle_switch_background_off: '#F5F7FA',

          tooltip_background: '#24292F',
          tooltip_text: '#FFFFFF',
        },
        light: {
          main_logo: '#16B862',
          main_background: '#f5f7fa',
          main_widget_surface: '#FFFFFF',
          main_widget_border: '#F0EFFF',
          main_alternative_colors: '#0D74E7',
          main_icons: '#2d2f43',

          breadcrumbs_text: '#5B5D73',
          breadcrumbs_icon: '#5B5D73',
          breadcrumbs_divider: '#BBBCD5',

          button_primary_background_default: '#2cc36c',
          button_primary_border_default: '#2aab62',
          button_primary_text_default: '#FFFFFF',
          button_primary_icon_default: '#FFFFFF',
          ...
          button_primary_background_disabled: '#ACF3BA',
          button_primary_border_disabled: '#ACF3BA',
          button_primary_text_disabled: '#FFFFFF',
          button_primary_icon_disabled: '#FFFFFF',

          button_primary_background_inactive: '#F5F7FA',
          button_primary_border_inactive: 'transparent',
          button_primary_text_inactive: '#A6ABB1',
          button_primary_icon_inactive: '#A6ABB1',

          button_primary_background_pressed: '#00A656',
          button_primary_border_pressed: '#00A656',
          button_primary_text_pressed: '#FFFFFF',
          button_primary_icon_pressed: '#FFFFFF',

          button_secondary_background_default: '#FFFFFF',
          button_secondary_border_default: '#1F2328',
          button_secondary_text_default: '#2D2F43',
          button_secondary_icon_default: '#2D2F43',

          button_secondary_background_focus: '#FFFFFF',
          button_secondary_border_focus: '#00a656',
          button_secondary_text_focus: '#2d2f43',
          button_secondary_icon_focus: '#2d2f43',

          button_secondary_background_hover: '#FFFFFF',
          button_secondary_border_hover: '#2D2F43',
          button_secondary_text_hover: '#2D2F43',
          button_secondary_icon_hover: '#2D2F43',

          button_secondary_background_pressed: '#F0EFFF',
          button_secondary_border_pressed: '#2D2F43',
          button_secondary_text_pressed: '#2D2F43',
          button_secondary_icon_pressed: '#2D2F43',

          button_secondary_background_disabled: '#ffffff',
          button_secondary_border_disabled: '#ffffff',
          button_secondary_text_disabled: '#ffffff',
          button_secondary_icon_disabled: '#ffffff',

          button_secondary_background_inactive: '#ffffff',
          button_secondary_border_inactive: 'transparent',
          button_secondary_text_inactive: '#ffffff',
          button_secondary_icon_inactive: '#ffffff',
          ...
          button_danger_background_focus: '#FF5449',
          button_danger_border_focus: '#000000',
          button_danger_text_focus: '#FFFFFF',
          button_danger_icon_focus: '#FFFFFF',

          button_danger_background_hover: '#BA1A1A',
          button_danger_border_hover: '#A31B1C',
          button_danger_text_hover: '#FFFFFF',
          button_danger_icon_hover: '#FFFFFF',
          ...
          button_danger_background_disabled: '#F5F7FA',
          button_danger_border_disabled: 'transparent',
          button_danger_text_disabled: '#E48C92',
          button_danger_icon_disabled: '#E48C92',

          button_danger_background_inactive: '#F5F7FA',
          button_danger_border_inactive: 'transparent',
          button_danger_text_inactive: '#413E53',
          button_danger_icon_inactive: '#413E53',

          button_invisible_background_default: 'transparent',
          button_invisible_border_default: '#00A656',
          button_invisible_text_default: '#00A656',
          button_invisible_icon_default: '#00A656',

          button_invisible_background_focus: 'transparent',
          button_invisible_border_focus: '#16B862',
          button_invisible_text_focus: '#00A656',
          button_invisible_icon_focus: '#00A656',

          button_invisible_background_hover: '#F6F7F8',
          button_invisible_border_hover: '#16B862',
          button_invisible_text_hover: '#16B862',
          button_invisible_icon_hover: '#16B862',

          button_invisible_background_pressed: 'transparent',
          button_invisible_border_pressed: '#16B862',
          button_invisible_text_pressed: '#16B862',
          button_invisible_icon_pressed: '#16B862',

          button_invisible_background_disabled: 'transparent',
          button_invisible_border_disabled: '#F0EFFF',
          button_invisible_text_disabled: '#F0EFFF',
          button_invisible_icon_disabled: '#F0EFFF',

          button_invisible_background_inactive: 'transparent',
          button_invisible_border_inactive: '#F0EFFF',
          button_invisible_text_inactive: '#00A656',
          button_invisible_icon_inactive: '#00A656',
          ...
          button_alternative_background_pressed: '#0D74E7',
          button_alternative_border_pressed: '#0969DA',
          button_alternative_text_pressed: '#FFFFFF',
          button_alternative_icon_pressed: '#FFFFFF',

          button_alternative_background_disabled: '#75D0DC',
          button_alternative_border_disabled: '#75D0DC',
          button_alternative_text_disabled: '#FFFFFF',
          button_alternative_icon_disabled: '#FFFFFF',

          button_alternative_background_inactive: '#F5F7FA',
          button_alternative_border_inactive: 'transparent',
          button_alternative_text_inactive: '#A6ABB1',
          button_alternative_icon_inactive: '#A6ABB1',

          checkbox_background_default: '#F5F7FA',
          checkbox_background_checked: '#16B862',
          checkbox_background_indeterminate: '#BBBCD5',

          checkbox_border_default: '#BBBCD5',
          checkbox_border_focus: '#0D0F22',

          checkbox_icon_checked: '#FFFFFF',
          checkbox_icon_indeterminate: '#FFFFFF',

          checkbox_text_indeterminate: '#BBBCD5',

          datepicker_background: '#F9FCFF',
          datepicker_border: '#9CA3AF',
          datepicker_days: '#413E53',
          datepicker_weeks_months: '#9CA3AF',
          datepicker_day_inversion: '#FFFFFF',

          footer_copyright: '#BBBCD5',
          footer_link: '#75768D',

          footer_nav_default: '#413E53',
          footer_nav_active: '#413E53',
          footer_nav_visited: '#413E53',
          footer_nav_hover: '#27273B',

          input_caption_text: '#1F2328',

          input_background_default: '#F5F7FA',
          input_background_inset: '#F5F7FA',
          input_background_disabled: '#F6F7F8',
          input_background_readonly: '#F5F7FA',

          input_placeholder_default: '#8E8FA7',
          input_placeholder_inset: '#1F2328',
          input_placeholder_hover: '#1F2328',
          input_placeholder_disabled: '#9CA3AF',
          input_placeholder_readonly: '#413E53',

          input_border_default: '#7D7B8C',
          input_border_hover: '#7D7B8C',
          input_border_invalid: '#DE3730',
          input_border_valid: '#00A656',
          input_border_focus: '#056234',
          input_border_pressed: '#1F2328',
          input_border_disabled: '#EAEEF2',

          input_icon_default: '#7D7B8C',
          input_icon_hover: '#7D7B8C',
          input_icon_invalid: '#DE3730',
          input_icon_valid: '#00A656',
          input_icon_focus: '#056234',
          input_icon_pressed: '#1F2328',
          input_icon_disabled: '#EAEEF2',

          input_message_invalid: '#DE3730',
          input_message_valid: '#00A656',

          link_background_surface_anchor: '#ffffff',
          link_background_anchor: '#ffffff',

          link_border_anchor_active: '#9495A9',
          link_border_anchor_surface: '#F0EFFF',
          link_border_anchor_muted: '#F0EFFF',

          link_text_default: '#7D7B8C',
          link_text_accent_green: '#008946',
          link_text_accent_light: '#16B862',

          link_icon_leading_default: '#BBBCD5',
          link_icon_leading_accent_green: '#00A656',
          link_icon_leading_accent_light: '#413E53',
          link_icon_trailing: '#413E53',

          menu_nav_default: '#413E53',
          menu_nav_active: '#2D2F43',
          menu_nav_visited: '#413E53',
          menu_nav_hover: '#413E53',

          menu_ham_menu_open: '#413E53',
          menu_ham_menu_closed: '#413E53',

          pagination_page_direction_default: '#00A656',
          pagination_page_direction_hover: '#2CC36C',
          pagination_page_direction_disabled: '#75768D',

          pagination_background_current: '#16B862',

          pagination_border_hover: '#413E53',

          pagination_text_default: '#000000',
          pagination_text_hover: '#000000',
          pagination_text_current: '#F5F7FA',

          radio_background_unchecked: '#F5F7FA',
          radio_background_disabled: '#F6F7F8',

          radio_dot_default: '#51E085',
          radio_dot_disabled: '#51E085',

          radio_border_default: '#5B5D73',
          radio_border_focus: '#16B862',
          radio_border_disabled: '#F0EFFF',

          select_background_default: '#F5F7FA',
          select_text_default: '#1F2328',
          select_icon_default: '#1F2328',

          select_background_hover: '#F0EFFF',
          select_text_hover: '#8E8FA7',
          select_icon_hover: '#8E8FA7',

          select_background_selected: '#F5F7FA',
          select_text_selected: '#1F2328',
          select_icon_selected: '#1F2328',

          code_navigator_background: '#ffffff',
          code_navigator_chevron: '#BBBCD5',
          code_navigator_folder: '#16B862',
          code_navigator_text: '#7D7B8C',
          code_navigator_icon: '#BBBCD5',
          code_navigator_focus: '#006D36',
          code_navigator_tag: '#C78603',
          ...
          text_default: '#7D7B8C',
          text_title: '#413E53',
          text_subtitle: '#7D7B8C',
          text_lines_of_subtitle: '#BBBCD5',
          text_label: '#413E53',

          toggle_switch_text_default: '#5B5D73',

          toggle_switch_border_default: '#ffffff',

          toggle_switch_toggle_on: '#ffffff',
          toggle_switch_toggle_off: '#ffffff',

          toggle_switch_background_on: '#16B862',
          toggle_switch_background_off: '#A8A9C2',
      ...
      fontSize: {
        ...
        h3: ['1.125rem', { lineHeight: '1.625rem' }], // 18px/26px
        h2: ['1.5rem', { lineHeight: '2rem' }], // 24px/32px
        h1: ['1.875rem', { lineHeight: '2.5rem' }], // 30px/40px
        subheadDesktop: ['2rem', { lineHeight: '3rem', fontWeight: '700' }], // 32px/48px
        subheadTablet: ['1.25rem', { lineHeight: '2rem', fontWeight: '700' }], // 20px/32px
        subheadMobile: ['1rem', { lineHeight: '1.5rem', fontWeight: '700' }], // 16px/24px
        placeholderMedium: [
          '0.875rem',
        ...
        label: ['0.875rem', { lineHeight: '1.25rem', fontWeight: '700' }], // 14px/20px
        validationText: [
          '0.75rem',
          { lineHeight: '1.25rem', fontWeight: '400' },
        ], // 12px/20px
        linkText: ['0.875rem', { lineHeight: '1.25rem', fontWeight: '400' }], // 14px/20px
      },
      fontWeight: {
        base: '400',
        bold: '700',
